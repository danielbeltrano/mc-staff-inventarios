    ...
    builder
      ...
      .addCase(restoreSession.fulfilled, (state, action) => {
        ...
        if (action.payload) {
          ...
          state.role = action.payload.role || 'authenticated';  // Fallback a 'authenticated'
        } else {
          state.user = null;
      ...
      .addCase(restoreSession.rejected, (state, action) => {
        ...
        state.user = null;
        state.role = 'authenticated';  // Fallback en caso de error
      })
      ...
      .addCase(registerUser.fulfilled, (state, action) => {
        state.status = 'succeeded';
        state.user = action.payload;
        state.role = action.payload.role || 'authenticated';  // Fallback en caso de que falte el rol
      })
      ...
      .addCase(fetchUsuarios.fulfilled, (state, action) => {
        state.status = 'succeeded';
        state.usuarios = action.payload;  // Guardar los usuarios en el estado
      })
      ...
      .addCase(loginUser.fulfilled, (state, action) => {
        state.status = 'succeeded';
        state.user = action.payload;
        state.role = action.payload.role || 'authenticated';  // Fallback a 'authenticated' en caso de que falte el rol
      })
      ...
      .addCase(logoutUser.fulfilled, (state) => {
        state.status = 'idle';
        state.user = null;
        state.role = 'authenticated';  // Resetear el rol al cerrar sesión
      });
  },
});
